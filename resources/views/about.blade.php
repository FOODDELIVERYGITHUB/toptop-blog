...
@include('headers')
    ...
    <div style="font-family: Sans-serif ;background-color:rgb(248,249,250);padding:18px;color:black"><br><h2 style="font-family: Sans-serif ;color:black;">About Us !</h2>
        <h2 style="font-family: Sans-serif ;text-align: center;">Welcome To <span id="W_Name1" >Toptop</span></h2>
        <p><span id="W_Name2">Toptop</span> is a Professional <span id="W_Type1">blogging</span> Platform. Here we will only provide you with interesting content that you will enjoy very much. We are committed to providing you the best of <span id="W_Type2">blogging</span>, with a focus on reliability and <span id="W_Spec">news</span>. we strive to turn our passion for <span id="W_Type3">blogging</span> into a thriving website. We hope you enjoy our <span id="W_Type4">blogging</span> as much as we enjoy giving them to you.</p>
